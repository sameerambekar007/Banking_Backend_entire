...
namespace Banking.Controllers
{
    public class NefttransferController : ApiController
    {
        ...
        public void Sendneftsuccessdebited(string To, string ref_id, decimal? amount, string mode, decimal? account_no, DateTime? tdate, string remarks)
        {
        ...
        public void Sendneftsuccesscredited(string To, string ref_id, decimal? amount, string mode, decimal? account_no, DateTime? tdate, string remarks)
        {
