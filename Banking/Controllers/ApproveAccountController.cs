...
{
    public class ApproveAccountController : ApiController
    {
        private BankingEntities1 db = new BankingEntities1();

        // GET: api/ApproveAccount
        public IQueryable<Customer> GetCustomers()
        {
            return db.Customers;
        }

        // GET: api/ApproveAccount/5
        ...
        // POST: api/ApproveAccount
        [ResponseType(typeof(Customer))]
        public IHttpActionResult PostCustomer(Customer customer)
        {
            db.approve_account(customer.service_ref_no);
            //if (!ModelState.IsValid)
            //{
            //    return BadRequest(ModelState);
            //}
